 ...
 * Size: 16 px
 * Bpp: 1
 * Opts: --no-compress --no-prefilter --bpp 1 --size 16 --font unscii-8.ttf -r 0x20-0x7F --format lvgl -o lgfx_lv_font_unscii_16.c --force-fast-kern-format
 ******************************************************************************/

#include "../../utility/lvgl/lvgl_font_support.h"

#ifndef LGFX_LV_FONT_UNSCII_16
    #define LGFX_LV_FONT_UNSCII_16 1
#endif

#if LGFX_LV_FONT_UNSCII_16
...
const lgfx_lv_font_t lgfx_lv_font_unscii_16 = {
...
#endif /*#if LGFX_LV_FONT_UNSCII_16*/
