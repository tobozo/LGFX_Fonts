 ...
 * Size: 8 px
 * Bpp: 1
 * Opts: --no-compress --no-prefilter --bpp 1 --size 8 --font unscii-8.ttf -r 0x20-0x7F --format lvgl -o lgfx_lv_font_unscii_8.c --force-fast-kern-format
 ******************************************************************************/

#include "../../utility/lvgl/lvgl_font_support.h"

#ifndef LGFX_LV_FONT_UNSCII_8
    #define LGFX_LV_FONT_UNSCII_8 1
#endif

#if LGFX_LV_FONT_UNSCII_8
...
static const lgfx_lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
...
static const lgfx_lv_font_fmt_txt_cmap_t cmaps[] = {
    {
        .range_start = 32, .range_length = 96, .glyph_id_start = 1,
        .unicode_list = NULL, .glyph_id_ofs_list = NULL, .list_length = 0, .type = LGFX_LV_FONT_FMT_TXT_CMAP_FORMAT0_TINY
    }
};
...
static const lgfx_lv_font_fmt_txt_dsc_t font_dsc = {
...
const lgfx_lv_font_t lgfx_lv_font_unscii_8 = {
    .get_glyph_dsc = lgfx_lv_font_get_glyph_dsc_fmt_txt,    /*Function pointer to get glyph's data*/
    .get_glyph_bitmap = lgfx_lv_font_get_bitmap_fmt_txt,    /*Function pointer to get glyph's bitmap*/
    .line_height = 9,          /*The maximum line height required by the font*/
    .base_line = 0,             /*Baseline measured from the bottom of the line*/

    .subpx = LGFX_LV_FONT_SUBPX_NONE,
    .underline_position = 0,
    .underline_thickness = 0,
    .dsc = &font_dsc           /*The custom font data. Will be accessed by `get_glyph_bitmap/dsc` */
};

#endif /*#if LGFX_LV_FONT_UNSCII_8*/
